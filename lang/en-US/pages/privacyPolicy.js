module.exports = {
  ...
  "rule1": `
      ...
      <p>
        Siam99 is committed to protecting your personal information. This Privacy Policy lets you know what information we collect when you use our services, why we collect this information and how we use the collected information.<br/>
        Please note that this Privacy Policy will be agreed between you and Siam99. (‘We’, ‘Us’ or ‘Our’, as appropriate). This Privacy Policy is an integrated part of Siam99’s Terms and Conditions. We may periodically make changes to this Privacy Policy and will notify you of these changes by posting the modified terms on our platforms. We recommend that you revisit this Privacy Policy regularly.
      </p>
  `,
  "rule2": `
    <h4>
  ...
  "rule4": `
    ...
    <ul>
      <li>
        <span>(1)</span>
        promotional offers and information regarding our products and services; and
      </li>
      <li>
        <span>(2)</span>
        promotional offers and information regarding the products and services of our partners, in order to enlarge the range of provided products and improve our customer service.
      </li>
    </ul>
    <p>
  ...
  "rule5": `
    ...
    <ul>
      <li>
        <span>(1)</span>
        comply with any legal process served on us, any of our sites or the services or in circumstances where we are under a substantially similar legal obligation; 
      </li>
      <li>
        <span>(2)</span>
  ...
  "rule6": `
    ...
    <p>
      You may ‘opt out’ of receiving any promotional communications either by choosing to opt out via your account settings available on our sites or the services or in an email you receive from us, or at any time by sending an email, or by writing to us at Customer Service.<br/>
    ...
    <ul>
      ...
      <li>
        <span>3)</span>
        have any complaint regarding our use of your Personal Information. If requested, we will: 
        <ul>
          <li>
            <span>(1)</span>
            update any information you have provided to us, in case you prove the necessity for such changes or 
          </li>
          <li>
            <span>(2)</span>
            mark any information to prohibit future use for marketing purposes. For the avoidance of doubt, nothing in this Privacy Policy shall prevent us from retaining your Personal Information where we are required to do so by law.
          </li>
        </ul>
      </li>
    </ul>
  ...
  "rule15": `
    ...
    <p>
      Your use of our services constitutes an agreement to our Privacy Policy.<br/>
